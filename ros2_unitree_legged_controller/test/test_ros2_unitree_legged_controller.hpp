...
{
  FRIEND_TEST(UnitreeLeggedControllerTest, CommandSuccessTest);
  FRIEND_TEST(UnitreeLeggedControllerTest, WrongCommandCheckTest);
  FRIEND_TEST(UnitreeLeggedControllerTest, CommandCallbackTest);
  FRIEND_TEST(UnitreeLeggedControllerTest, StopJointsOnDeactivateTest);
};

class UnitreeLeggedControllerTest : public ::testing::Test
{
public:
