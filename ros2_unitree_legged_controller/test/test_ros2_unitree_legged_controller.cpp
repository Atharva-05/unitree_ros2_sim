...
#include "test_ros2_unitree_legged_controller.hpp"
...
void UnitreeLeggedControllerTest::SetUpTestCase() { rclcpp::init(0, nullptr); }

void UnitreeLeggedControllerTest::TearDownTestCase() { rclcpp::shutdown(); }

void UnitreeLeggedControllerTest::SetUp()
{
  controller_ = std::make_unique<FriendJointGroupEffortController>();
}

void UnitreeLeggedControllerTest::TearDown() { controller_.reset(nullptr); }

void UnitreeLeggedControllerTest::SetUpController()
{
...
TEST_F(UnitreeLeggedControllerTest, JointsParameterNotSet)
{
  SetUpController();
...
TEST_F(UnitreeLeggedControllerTest, JointsParameterIsEmpty)
{
  SetUpController();
...
TEST_F(UnitreeLeggedControllerTest, ConfigureAndActivateParamsSuccess)
{
  SetUpController();
...
TEST_F(UnitreeLeggedControllerTest, ActivateWithWrongJointsNamesFails)
{
  SetUpController();
...
TEST_F(UnitreeLeggedControllerTest, CommandSuccessTest)
{
  SetUpController();
  controller_->get_node()->set_parameter({"joints", joint_names_});
  ASSERT_EQ(controller_->on_configure(rclcpp_lifecycle::State()), CallbackReturn::SUCCESS);
...
TEST_F(UnitreeLeggedControllerTest, WrongCommandCheckTest)
{
  SetUpController();
  controller_->get_node()->set_parameter({"joints", joint_names_});
  ASSERT_EQ(controller_->on_configure(rclcpp_lifecycle::State()), CallbackReturn::SUCCESS);
...
TEST_F(UnitreeLeggedControllerTest, NoCommandCheckTest)
{
  SetUpController();
  controller_->get_node()->set_parameter({"joints", joint_names_});
  ASSERT_EQ(controller_->on_configure(rclcpp_lifecycle::State()), CallbackReturn::SUCCESS);
...
TEST_F(UnitreeLeggedControllerTest, CommandCallbackTest)
{
  SetUpController();
  controller_->get_node()->set_parameter({"joints", joint_names_});
...
TEST_F(UnitreeLeggedControllerTest, StopJointsOnDeactivateTest)
{
  SetUpController();
  controller_->get_node()->set_parameter({"joints", joint_names_});
